library(ggplot2)
library(tidyverse)
setwd("/Users/susyh./Desktop/BIOL3140/Susanne Hahs project 1")
...
#Code that reports class of each column in dataset
sapply(dat,class)
...
#Code that reports dimensions of dataset 
...
#Code that shows PDF file for each species
